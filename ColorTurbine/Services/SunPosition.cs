...
public class SunPosition
{
    ...
    public class SunPos
    {
        public SunPos(double altitude, double azimuth)
        {
            this.altitude = altitude;
            this.azimuth = azimuth;
            this.isNightMode = altitude < -8;

            this.brtscl = 1.0;
            if (!isNightMode && altitude < 5)
            {
                this.brtscl = Math.Max(1 - ((altitude - 5) / (-8 - 5)), 0.1);
            }
        }
        public double altitude { get; private set; }
        public double azimuth { get; private set; }
        public bool isNightMode { get; private set; }
        public double brtscl { get; private set; }
    }
     ...
     */
    public SunPos CalculateSunPosition(DateTime dateTime)
    {
        // Convert to UTC
        ...
        return new SunPos(altitude * Rad2Deg, azimuth * Rad2Deg);
    }
